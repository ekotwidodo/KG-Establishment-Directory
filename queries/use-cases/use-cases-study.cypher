...
MATCH (e:Perusahaan)-[r:DIKLASIFIKASIKAN_SEBAGAI]->(b:Kelompok_KBLI)
RETURN e,r,b;
...
MATCH (e:Perusahaan)-[r1:DIKLASIFIKASIKAN_SEBAGAI]->(b:Kelompok_KBLI)
MATCH (b)-[r2:TERMASUK_DALAM]->(g:Golongan_Pokok_KBLI)
RETURN e,r1,b,r2,g;
...
MATCH (e)-[r3:DIKLASIFIKASIKAN_SEBAGAI]->(b:Kelompok_KBLI)
